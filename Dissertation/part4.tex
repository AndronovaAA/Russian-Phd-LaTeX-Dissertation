...
\begin{equation}
	...
	\end{bmatrix}<0,
\end{equation}
Используем леммы \ref{lemma:Young}, \ref{lemma:Schur} и замены переменных аналогично выражениям \ref{eq:thm3_before_Young_2}-\ref{eq:thm3_LMI_before_alpha_beta}, получаем
